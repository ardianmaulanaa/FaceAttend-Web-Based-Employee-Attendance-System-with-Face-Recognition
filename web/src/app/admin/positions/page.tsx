...
export default function AdminPositionsPage() {
  ...
  async function handleDeletePosition(position: Position) {
    ...
    const confirmDelete = window.customConfirm
      ? await window.customConfirm(`Yakin ingin menghapus jabatan "${position.name}"? Data yang dihapus tidak bisa dikembalikan.`)
      : window.confirm(`Yakin ingin menghapus jabatan "${position.name}"? Data yang dihapus tidak bisa dikembalikan.`);
